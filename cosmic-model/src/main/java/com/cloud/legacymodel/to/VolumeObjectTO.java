...
public class VolumeObjectTO implements DataTO {
    ...
    public VolumeObjectTO(final String uuid, final VolumeType volumeType, final DataStoreTO dataStore, final String name, final Long size, final String path, final Long volumeId,
                          final String vmName, final long accountId, final String chainInfo, final ImageFormat format, final StorageProvisioningType provisioningType, final long id,
                          final Long deviceId, final Long bytesReadRate, final Long bytesWriteRate, final Long iopsReadRate, final Long iopsWriteRate, final Long iopsTotalRate,
                          final Boolean iopsRatePerGb, final DiskCacheMode cacheMode, final HypervisorType hypervisorType) {
        this.uuid = uuid;
